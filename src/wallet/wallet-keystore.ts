...
export type WalletKeystoreFileV1 = {
...
export type WalletKeystoreFile = WalletKeystoreFileV1;
...
export function readWalletKeystoreFile(filePath: string): WalletKeystoreFile | null {
...
export function saveWalletKeystoreFile(filePath: string, keystore: WalletKeystoreFile): void {
  ensureDir(filePath);
...
export function createWalletKeystoreFile(params: {
  address: string;
  ...
  const aad = Buffer.from(params.aad, "utf8");
...
export function decryptWalletKeystoreFile(params: {
